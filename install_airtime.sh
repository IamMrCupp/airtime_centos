...
function install() {
    ...
    /tmp/Airtime-airtime-2.5.1-ga/python_apps/python-virtualenv/virtualenv-install.sh

    #web files
    echo "* Configuring httpd"
    cp /tmp/Airtime-airtime-2.5.1-ga/install_full/apache/airtime-vhost /etc/httpd/conf.d/airtime.conf
    ...
    cp -R /tmp/Airtime-airtime-2.5.1-ga/airtime_mvc/* /var/www/html/airtime

    mkdir -p /etc/airtime
    mkdir -p /srv/airtime/stor

    echo "* Creating Airtime Database"
    cp /tmp/Airtime-airtime-2.5.1-ga/airtime_mvc/build/airtime.conf /etc/airtime/airtime.conf
    ...
    cd /tmp/Airtime-airtime-2.5.1-ga/airtime_mvc/build/sql
    ...
    python /tmp/Airtime-airtime-2.5.1-ga/python_apps/api_clients/install/api_client_install.py
    cp -R /tmp/Airtime-airtime-2.5.1-ga/python_apps/std_err_override /usr/lib/airtime

    python /tmp/Airtime-airtime-2.5.1-ga/python_apps/media-monitor/install/media-monitor-copy-files.py
    python /tmp/Airtime-airtime-2.5.1-ga/python_apps/media-monitor/install/media-monitor-initialize.py
    python /tmp/Airtime-airtime-2.5.1-ga/python_apps/pypo/install/pypo-copy-files.py
    
    #TODO remove dependency on debian liquidsoap 
    python /tmp/Airtime-airtime-2.5.1-ga/python_apps/pypo/install/pypo-initialize.py || true
